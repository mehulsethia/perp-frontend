      ...
      <div className="w-full bg-[#1B1C39] py-2 px-3 rounded-lg">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between ">
          ...
          <div className="flex flex-col mb-6 lg:mb-0">
            <span className="text-base xl:text-lg font-bold text-white font-sfPro">
              6,654$
            </span>
            <span className="text-gray-400 text-sm">6,654</span>
          </div>

          {/* Metrics Section */}
          <div className="grid grid-cols-2  md:grid-cols-2 lg:flex lg:items-center lg:space-x-6 xl:space-x-12 gap-6 lg:gap-0">
            {metrics.map((metric, index) => (
              <div key={index} className="flex items-start">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-gray-400 mt-0.5 -ml-3">
                    {metric.value}
                  </span>
                </div>
              </div>
