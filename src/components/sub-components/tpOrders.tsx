...
export default function TpOrders({ address, chainConstants, orders, allPrices, setOrderUpdate }: ITpOrders) {
  ...
  return (
    <>
      ...
      <Modal isOpen={isEditOpen} onClose={onEditClose}>
        ...
        <ModalContent>
          <ModalHeader>
            Edit {assetLabel} {isLong ? "Long" : "Short"} TP
          </ModalHeader>
          <ModalCloseButton />
          <ModalBody>
      ...
      <Modal isOpen={isCancelOpen} onClose={onCancelClose}>
        ...
        <ModalContent>
          <ModalHeader>
            Cancel {assetLabel} {isLong ? "Long" : "Short"} TP
          </ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <Flex direction={"column"} gap={2} mt={4} backgroundColor={"gray.700"} p={1} rounded={"md"}>
