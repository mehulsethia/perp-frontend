      ...
      >
        <>
          <VStack>
            ...
            <div className="bg-[#0B0B20] p-3 w-full flex justify-between items-center rounded-xl">
              <div>Your Token in Pool </div>
            ...
            {/* Withdraw Component */}
            <div className=" p-3 w-full flex justify-between items-center rounded-xl">
              <div>Withdraw</div>
              ...
              <div className="flex  items-center justify-between space-x-1  bg-[#0B0B20] px-1 py-2 rounded-xl ">
                ...
                <input className="outline-none text-right w-20 bg-transparent" />
              </div>
            </div>
          </VStack>
